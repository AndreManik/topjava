...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        for (UserMealWithExceed umwe : getFilteredWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(12,0), 2000)) {
            System.out.println(umwe.getDateTime() + " " + umwe.getDescription() + " " + umwe.getCalories() + " " + umwe.isExceed());
        }
    }
